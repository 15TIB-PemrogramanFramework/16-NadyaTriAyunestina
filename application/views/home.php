...
<div id="works"  class=" clearfix grid"> 
    <figure class="effect-oscar  wowload fadeIn">
        ...
        <figcaption>
            ...
            <a href="<?php echo base_url('prawedding/prawedding'); ?>"/>View more</a></p>
     ...
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            ...
            <a href="<?php echo base_url('wedding/wedding');?>"/>View more</a></p>            
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            ...
            <a href="<?php echo base_url('group/group');?>"/>View more</a></p>            
        </figcaption>
    </figure>

...
<div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="<?php echo site_url()?>assets/admin/uploads/<?php echo $value->gambar_wedding; ?>" alt=""></a>
            <div class="card-body">
              <h4 class="card-title">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"> <?php echo $value->paket_wedding; ?></li>
                    <li class="list-group-item"> <?php echo $value->deskripsi_wedding;; ?></li>
                    <li class="list-group-item"><?php echo $value->harga_wedding; ; ?></li>

                    <li class="list-group-item">
                        <center>
                        <a href="<?php echo base_url()."pesanwedding/tambah/".$value->kode_wedding?>" class="btn btn-primary">Pesan</a>
                        </center>
                    </li>
                </ul>
...
<div id="partners" class="container spacer ">
  ...
  <div class="clearfix">
    <div class="col-sm-6 partners  wowload fadeInLeft">
         <img src="<?php echo base_url('images/partners/1.jpg');?>" alt="partners"/>
         <img src="<?php echo base_url('images/partners/2.jpg');?>" alt="partners"/>
         <img src="<?php echo base_url('images/partners/3.jpg');?>" alt="partners"/>
         <img src="<?php echo base_url('images/partners/4.jpg');?>" alt="partners"/>
    </div>
    <div class="col-sm-6">
    ...
    <div class="carousel-inner">  
      ...
      <div class="animated slideInLeft col-xs-2"><img alt="portfolio" src="<?php echo base_url('images/team/1.jpg');?>" width="100" class="img-circle img-responsive"/></div>
      <div  class="col-xs-10">
      ...
      <div class="animated slideInLeft col-xs-2"><img alt="portfolio" src="<?php echo base_url('images/team/2.jpg');?>" width="100" class="img-circle img-responsive"/></div>
      <div  class="col-xs-10">
      ...
      <div class="item  animated bounceInRight row">
      <div class="animated slideInLeft  col-xs-2"><img alt="portfolio" src="<?php echo base_url('images/team/3.jpg');?>" width="100" class="img-circle img-responsive"/></div>
      <div  class="col-xs-10">

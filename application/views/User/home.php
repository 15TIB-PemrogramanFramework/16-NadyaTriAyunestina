...
<div id="works"  class=" clearfix grid"> 
    <figure class="effect-oscar  wowload fadeIn">
         <img src="<?php echo base_url('images/portfolio/prawedding3.PNG');?>" alt="img01"/>
        <figcaption>
            <h2>Prawedding</h2>
            <p>Our satisfied client before they wedding comes<br>
            <a href="<?php echo base_url('prawedding/praweddingMember'); ?>"/>View more</a></p>

        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        <img src="<?php echo base_url('images/portfolio/wedding2.jpg');?>" alt="img01"/>
        <figcaption>
            <h2>Wedding</h2>
            <p>Capture a precious moment on your wedding<br>
            <a href="<?php echo base_url('wedding/weddingMember');?>"/>View more</a></p>            
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        <img src="<?php echo base_url('images/portfolio/group1.PNG');?>" alt="img01"/>
        <figcaption>
            <h2>Group</h2>
            <p>Laugh with your best in one frame.<br>
            <a href="<?php echo base_url('group/groupMember');?>"/>View more</a></p>            
        </figcaption>
    </figure>
...
<div class="row grid team  wowload fadeInUpBig">  
  ...
  <figure class="effect-chico">
        ...
        <figcaption>
            <p><b>Vinza</b><br>Videographer<br><br><a href="https://www.instagram.com/vinzaputra86/?hl=en"><i class="fa fa-instagram"></i></a> <a href="https://www.facebook.com/kennykurniawan674"><i class="fa fa-facebook"></i></a></p> 
        </figcaption>
    </figure>
    </div>

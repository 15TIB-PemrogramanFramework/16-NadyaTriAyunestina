...
<div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="<?php echo site_url()?>assets/admin/uploads/<?php echo $value->gambar_group; ?>" alt=""></a>
            <div class="card-body">
              <h4 class="card-title">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"> <?php echo $value->paket_group; ?></li>
                    <li class="list-group-item"> <?php echo $value->deskripsi_group;; ?></li>
                    <li class="list-group-item"><?php echo $value->harga_group; ; ?></li>

                    <li class="list-group-item">
                        <center>
                        <a href="<?php echo base_url()."pesangroup/tambah/".$value->kode_group?>" class="btn btn-primary">Pesan</a>
                        </center>
                    </li>
                </ul>
            </div>
